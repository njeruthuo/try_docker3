...
DATABASES = {
    'default': {
        ...
        'NAME': config("DJANGO_DB_NAME", default='mydatabase'),
        'USER': config("DJANGO_DB_USER", default='myuser'),
        'PASSWORD': config("DJANGO_DB_PASSWORD", default='mypassword'),
...
CSRF_TRUSTED_ORIGINS = config("DJANGO_CSRF_TRUSTED_ORIGINS", default='http://localhost:8001').split(',')